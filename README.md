...
| Competition | Placement | Score | Note |
|---|---|---|---|
| [Titanic — Machine Learning from Disaster](https://www.kaggle.com/competitions/titanic) | — | 0.76555 | Classification |
| [House Prices — Advanced Regression Techniques](https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques) | — | 0.11932 | Regression |

**Panel** · [`Examples/Panel/`](Examples/Panel/)

| Competition | Placement | Score | Note |
|---|---|---|---|
| [Store Sales — Time Series Forecasting](https://www.kaggle.com/competitions/store-sales-time-series-forecasting/) | **45 / 904** (Top 5%) | 0.39350 | Live competition, March 2026 |
| [Optiver Realized Volatility Prediction](https://www.kaggle.com/competitions/optiver-realized-volatility-prediction/) | **9 / 3809** (Top 1%) | 0.20323 | Late submission — used as integration benchmark |
